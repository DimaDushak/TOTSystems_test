...
export function Logo({ className }: ILogoProps) {
    return (
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 512 512"  xmlSpace="preserve" width="50%" className={className}>
            <path 
                d="M490.107,1.69L8.275,243.606c-4.862,2.441-8.021,7.323-8.255,12.757c-0.234,5.435,2.491,10.571,7.125,13.421
